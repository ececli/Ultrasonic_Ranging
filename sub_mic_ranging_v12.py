...
if __name__ == '__main__':
    ...
    try:
        ...
        while True:
            ...
            # check Bluetooth Data at every loop
            raw_bt_data = 0
            try:
                if ID == 1:
            ...
            if raw_bt_data: # if received Bluetooth Data
            ...
            if ID == 1:
                ...
                if timeoutCount >= max_timeoutCount:
                    ...
                    if Flag_ExpRX:
                        msgTO = f"Timeout due to missing detection of RX Signal at, {counter_NumRanging}, {counter}"
                    elif Flag_ExpTX:
                        msgTO = f"Timeout due to missing detection of TX Signal at, {counter_NumRanging}, {counter}"
                    elif Flag_recvdRX:
                        msgTO = f"Timeout due to missing detection of Bluetooth Signal at, {counter_NumRanging}, {counter}"
                    else:
                        msgTO = f"Timeout due to other reason at, {counter_NumRanging}, {counter}"
                    print(msgTO)

...
# v11 - is the version using a seperate python code, i.e., BtComm_v2.py, which in charge of communication. This code (v11)
#       uses zmq to communicate with Bt_Comm_v2.py. 
...
# Usage of non-blocking method for receiving bluetooth data: (for v10)
...
# Usage of non-blocking method for receiving ZMQ data in pub-sub mode: 
# The usage of non-blocking method of ZMQ is similar to the bluetooth socket. It actually easier to find the setting of non-blocking than
# bluetooth library. You can find the API here [5]. 
# [5] https://pyzmq.readthedocs.io/en/latest/api/zmq.html?highlight=NOBLOCK#zmq.Socket.send
# A good example of using non-blocking method can be found in [4]. 
    ...
    try:
        ...
        while True:
            ...
            if Flag_recvBluetooth:
                try:
                    raw_bt_data = subscriber.recv(flags=zmq.NOBLOCK)

...
/*  0 */ _CFFI_OP(_CFFI_OP_FUNCTION, 8), // void()(int32_t *, int, double *, double *, double)
/*  1 */ _CFFI_OP(_CFFI_OP_POINTER, 7), // int32_t *
/*  2 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 7), // int
/*  3 */ _CFFI_OP(_CFFI_OP_POINTER, 5), // double *
/*  4 */ _CFFI_OP(_CFFI_OP_NOOP, 3),
/*  5 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 14), // double
/*  6 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/*  7 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 21), // int32_t
/*  8 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 0), // void
};

static void _cffi_d_sg_block(int32_t * x0, int x1, double * x2, double * x3, double x4)
{
  sg_block(x0, x1, x2, x3, x4);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_sg_block(PyObject *self, PyObject *args)
{
  int32_t * x0;
  int x1;
  double * x2;
  ...
  if (!PyArg_UnpackTuple(args, "sg_block", 5, 5, &arg0, &arg1, &arg2, &arg3, &arg4))
    return NULL;
...
#else
#  define _cffi_f_sg_block _cffi_d_sg_block
#endif

static const struct _cffi_global_s _cffi_globals[] = {
  { "sg_block", (void *)_cffi_f_sg_block, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 0), (void *)_cffi_d_sg_block },
};
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit__goertzel(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit__goertzel(void) { return NULL; }
#  else
     init_goertzel(void) { }
#  endif
#  endif
...
PyMODINIT_FUNC
PyInit__goertzel(void)
{
  return _cffi_init("_goertzel", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
init_goertzel(void)
{
  _cffi_init("_goertzel", 0x2601, &_cffi_type_context);
}
#endif
